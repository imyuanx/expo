            ...
            Program: {
                ...
                exit(path, state) {
                    ...
                    state.exportDefault.forEach((e) => {
                        if (e.namespace) {
                            body.push(withLocation(
                            // TODO: Can we avoid the '*' check here? In case of import * as x from 'a' all keys of x are live bound already.
                            // e.local === '*'
                            //   ? liveBindExportNamespaceTemplate({
